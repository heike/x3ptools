x3p_bin_rotate_1 <- x3p_vertical_1(x3p_inner_impute, min_score_cut = 25, loess_span = 0.2)
x3p_bin_rotate_2 <- x3p_vertical_2(x3p_inner_impute, min_score_cut = 25, loess_span = 0.2)
